...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 10, 2019 at 05:02 PM
...
(35, 'ttgtg', 'tgtgtgttgg', 0),
(36, 'aaaaa', 'dddddd', 0),
(37, 'wwwwwwwwwww', 'wwwwwwwwwwwwww', 0),
(38, 'tgt\'gt', 'gtgtg', 0),
(39, 'hyhyh hyyhh', 'hyyhy hyyhy', 0),
(40, 'ds ', 'xsxsx', 0);
...
CREATE TABLE `depart` (
  ...
  `titrePromotion` varchar(250) DEFAULT NULL,
...
(13, 5, '2019-06-08', 1, 1234, 'eeeee', 0.01, 0),
(14, 5, '2019-06-11', 1, 345, '1', 1, 1),
(15, 13, '2019-06-10', 10, 12, '1', 1, 0),
(16, 40, '2019-06-10', 12, 2323, 'none', 0, 0),
(17, 5, '2019-06-12', 18, 2323, 'none', 0, 0),
(18, 37, '2019-06-03', 34, 4545, 'none', 0, 1),
(19, 35, '2019-06-10', 1, 4545, 'rfrfrfrfrf', 34, 0);
...
CREATE TABLE `hebergement` (
  ...
  `idLieu` int(11) NOT NULL,
  `nom` varchar(250) NOT NULL,
  `typeHebergement` varchar(250) DEFAULT NULL,
...
(13, 36, 'assets/images/aaaaa.jpg'),
(14, 37, 'assets/images/wwwwwwwwwww.jpg'),
(15, 38, 'assets/images/.jpg'),
(16, 39, 'assets/images/38.jpg'),
(17, 40, 'assets/images/40.jpg');
...
(15, 'eeeeeeeeee', 'ttrrrrrrrrrrrrrrr', 'ttt@rrrrs.com', '$2y$10$c80KFdmlSxlWJ7DR/mjC7uzplufnPoh0JPiAvhMGSpt/o4Y8BnL5W', NULL, NULL, NULL, NULL, NULL, 'Admin'),
...
(21, 'frfr', 'frfr', 'frfr@gmail.com', '$2y$10$Jb0q344hyEosp0L804m/yuewO4QfhGc3zh665h0XOTG1Z4bJrBtde', NULL, NULL, NULL, NULL, NULL, 'Membre'),
(22, 'cdcd', 'cdc', 'dcdc@gmail.com', '$2y$10$FzQpLWQz2gNUmoBSQU8JgedsH1.Yli0/Hn6cYl/tOMWROTpXS.7vO', NULL, NULL, NULL, NULL, NULL, 'Membre');
...
--
ALTER TABLE `circuit`
  MODIFY `idCircuit` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
--
...
--
ALTER TABLE `hebergement`
  MODIFY `idHebergement` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
--
...
--
ALTER TABLE `lieu`
  MODIFY `idLieu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
--
