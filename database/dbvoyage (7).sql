...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 09, 2019 at 09:07 PM
...
(5, 3, 'Problème avec un client', 'Un client veut changer la date de son circuit, mais le circuit pour la date qu\'il a choisi est complet', '2019-06-03 07:00:00', 0),
...
--
ALTER TABLE `circuit`
  MODIFY `idCircuit` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
...
--
ALTER TABLE `depart`
  MODIFY `idDepart` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
