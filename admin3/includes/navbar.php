  ...
  <li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="modifierCircuit.php">Modifier Circuit</a>
        <a class="collapse-item" href="supprimerCircuit.php">Supprimer Circuit</a>
      </div>
    </div>
  </li>
  <li class="nav-item">
